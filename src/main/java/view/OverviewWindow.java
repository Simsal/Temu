...
public class OverviewWindow implements ActionListener {
	...
	JLabel deviceLabel, device, measurementLabel, measurement, statusLabel, status, emptyLabel1, emptyLabel2, emptyLabel3, emptyLabel4, emptyLabel5;
	JPanel tempPanel;
	...
	public OverviewWindow(SerialPort serialport) {
		...
		infoLabel1.setToolTipText("Mit diesem Gerät ist derzeit eine Verbindung hergestellt. ");
		window.add(infoLabel1);

		measurementLabel = new JLabel("<html><b>Aktueller Messwert [°C]</b></html>");
		...
		infoLabel2.setToolTipText("Der gemessene Temperaturwert. Kann über den Button 'Werte aktualisieren' aktualisiert werden.");
		...
		infoLabel3.setToolTipText("<html>Der ausgelesene Fehlerstatus. Kann über den Button 'Werte aktualisieren' aktualisiert werden.<br>"
		...
		stopConfiguration = new JButton("Konfigurationsprogramm schliesen");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((JButton) e.getSource() == refresh){
			measurement.setText(communicationInterface.getCurentMeasurementValue(chosenPort));
